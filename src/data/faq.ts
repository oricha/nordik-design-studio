...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer: `NordiK no actúa como entidad financiera regulada UE: no concedemos préstamos directos desde balance propio. Coordinamos dossier BIM y facturas proforma para instituciones nórdicas o ibéricas conocidas donde cliente ya tiene relación mercantil, y algunos desarrolladores B2B con contratos repetitivos negocian esquema de pagos aplazados documentado en orden jurídico del país destino cuando créditos comerciales internos están aprobados tras due diligence financiero.\n\nParticulares suelen usar hipoteca obra y liberación contra hitos: nuestros PaymentMilestones en fichas proyecto ilustran un esquema orientativo.`,
  },
  {
    id: "proceso-zonas",
    category: "proceso",
    question: "¿Dónde entregan?",
    answer: `Operamos cargas multimodales con foco Unión Europea y extensiones mediante partners logísticos certificados. Países bálticos y península ibérica figuran ejemplo en dossier porque sede soporte España + HQ Finland facilita idioma cercano cliente y documentación BIM entendible ante banca local sin traducciones excesivas. Entregamos también Laponia, Benelux, Alemania, Portugal cuando acceso físico permite grúas requeridas y permisos de paso están sellados tiempo.\n\nNo prometemos plazada aduanera donde cliente no proporcione clase arancel/clasificación correcta.`,
  },
  {
