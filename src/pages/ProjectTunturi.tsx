...
const ProjectTunturi = () => {
  ...
  const [customizations, setCustomizations] = useState<CustomOption[]>([
    { name: "Kitchen furniture & Appliances", items: 6, price: 5000, added: false },
    { name: "Bathroom appliances", items: 5, price: 4500, added: false },
    { name: "Heating", items: 2, price: 5500, added: false },
  ]);
        ...
        <section className="relative w-full h-[70vh] min-h-[500px] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 p-8 md:p-16 max-w-lg">
            ...
            <div className="flex gap-6 text-background/80 text-sm mb-6">
              ...
              <span className="flex items-center gap-1"><BedDouble className="w-4 h-4" /> 4 bedrooms</span>
              <span className="flex items-center gap-1"><Bath className="w-4 h-4" /> 2 bathrooms</span>
            </div>
            <p className="text-background/70 text-sm">
              Construction time: <strong className="text-background">5–6 months</strong>
            </p>
