...
const ProjectOulu = () => {
  ...
  const [customizations, setCustomizations] = useState<CustomOption[]>([
    { name: "Kitchen furniture & Appliances", items: 6, price: 3500, added: false },
    { name: "Bathroom appliances", items: 5, price: 3200, added: false },
    { name: "Heating", items: 2, price: 3800, added: false },
  ]);
        ...
        <section className="relative w-full h-[70vh] min-h-[500px] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 p-8 md:p-16 max-w-lg">
            ...
            <div className="flex gap-6 text-background/80 text-sm mb-6">
              ...
              <span className="flex items-center gap-1"><Bath className="w-4 h-4" /> 1 bathroom</span>
            </div>
            <p className="text-background/70 text-sm">
              Construction time: <strong className="text-background">4–5 months</strong>
            </p>
