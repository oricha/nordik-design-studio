...
const ProjectKuusamo = () => {
  ...
  const [customizations, setCustomizations] = useState<CustomOption[]>([
    ...
    { name: "Calefacción", items: 2, price: 4000, added: false },
  ]);
          ...
          <div className="absolute bottom-0 left-0 p-8 md:p-16 max-w-lg">
            ...
            <div className="flex gap-6 text-background/80 text-sm mb-6">
              <span className="flex items-center gap-1">
                <Maximize2 className="w-4 h-4" /> 80 m²
              </span>
              <span className="flex items-center gap-1">
                <BedDouble className="w-4 h-4" /> 2 habitaciones
              </span>
              <span className="flex items-center gap-1">
                <Bath className="w-4 h-4" /> 1 baño
              </span>
            </div>
