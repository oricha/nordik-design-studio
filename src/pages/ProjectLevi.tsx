...
const ProjectLevi = () => {
  ...
  const [customizations, setCustomizations] = useState<CustomOption[]>([
    { name: "Kitchen furniture & Appliances", items: 6, price: 4000, added: false },
    { name: "Bathroom appliances", items: 5, price: 3500, added: false },
    { name: "Heating", items: 2, price: 4500, added: false },
  ]);
